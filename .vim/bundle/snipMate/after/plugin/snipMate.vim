...
"ino <silent> <s-tab> <c-r>=BackwardsSnippet()<cr> "因為 S-Tab 須要被拿來當做打 TAB 的 key, 所以這邊 unbind
"snor <silent> <s-tab> <esc>i<right><c-r>=BackwardsSnippet()<cr> "因為 S-Tab 須要被拿來當做打 TAB 的 key, 所以這邊 unbind
